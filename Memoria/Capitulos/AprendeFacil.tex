...
Para acceder al primero se debe de realizar una petición GET de la siguiente manera: https://holstein.fdi.ucm.es/tfg-analogias/image\_word/\textit{palabra}.
...
Por ejemplo, si se quisieran obtener el pictograma la palabra coche se haría de esta manera:

https://holstein.fdi.ucm.es/tfg-analogias/image\_word/coche


Por otro lado, para acceder al segundo se debe hacer una petición GET a la siguiente url: https://holstein.fdi.ucm.es/tfg-analogias/image\_offset/\textit{offset}
