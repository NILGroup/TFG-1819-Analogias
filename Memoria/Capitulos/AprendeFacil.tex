...
\begin{itemize}
	...
	\item Palabras fáciles: Son tres tablas llamadas ``1000\_palabras\_faciles'', ``5000\_palabras\_faciles'' y ``10000\_palabras\_faciles'' que contienen la palabras fáciles de la RAE. Las tres se componen de dos columnas:
	\begin{itemize}
