...
\end{itemize} 
Además, para cada uno de los sinónimos contenidos en el\textit{synset} de una palabra, se pueden obtener sus antónimos, esto debe de hacerse para cada uno de los sinónimos, para el \textit{synset} entero no esta disponible. En caso de que la palabra tenga distintos significados, aparecerá un \textit{synset} por cada una\footnote{http://www.nltk.org/howto/wordnet.html}.
