...
\begin{itemize}
	...
	\item @id: Concepto que se ha buscado y su idioma. En nuestro caso, aparece de la siguiente manera: \textit{/c/es/pelea}, donde  \textit{c} significa concepto,  \textit{es} indica el lenguaje, en este caso, el español y por último \textit{pelea} que es la palabra buscada.
