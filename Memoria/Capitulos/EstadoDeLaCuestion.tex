...
Se puede ver en el Listing \ref{lst:ejemWordNet} la forma de obtener la lista de \textit{synsets} de la palabra coche y a continuación del primer \textit{synset} de la lista, se muestran por pantalla cada uno de sus sinónimos (en español), su definición, una oración de ejemplo, sus hiperónimos, hipónimos y holónimos. Por último, del primer \textit{lemma}, se obtienen sus antónimos.
